...
import { Attachment, Avatar, LoadingIndicator, MessageInput, ReactionSelector, ReactionsList } from 'stream-chat-react';
import { MessageActionsBox } from "./components/MessageActionsBox"
import { MessageRepliesCountButton } from "./components/MessageRepliesCountButton"
 ...
 */
class CustomMessageComponent extends PureComponent {
  static propTypes = {
  ...
  render() {
    ...
    const messageTime = message.status === 'sending' ? "" : (message.updated_at instanceof Date) && message.updated_at.toLocaleString('en-US', { hour: 'numeric', minute: "2-digit", hour12: true })

    // const messageClasses = this.isMine()
    //   ? 'str-chat__message str-chat__message--me str-chat__message-simple str-chat__message-simple--me'
    //   : 'str-chat__message str-chat__message-simple';

    const messageClasses = "str-chat__message str-chat__message-simple"
    ...
    return (
      <React.Fragment>
        ...
        >
          ...
          />
          <div
            className="str-chat__message-inner w-100"
            onClick={
              message.status === 'failed'
          ...
          >
            ...
            {message.text && (
              <div className="str-chat__message-text w-100 justify-content-between">
                <div
                className={`
